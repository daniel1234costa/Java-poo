# 6. [FCC - 2022 - Analista Judiciário - Tecnologia da Informação] Considere o código Java
abaixo.
``` java 
public class Main {
...
# 7. [UFMA - 2023 - Analista de Tecnologia da Informação] Na linguagem de programação
JAVA, qual das seguintes alternativas representa uma declaração válida?
...
9. [CS-UFG - 2024 - Câmara de Anápolis - GO - Analista Administrativo - Analista de Sistemas] Considere o trecho abaixo de código escrito na linguagem Java
int index, aux, i, j;
for (i = 0; i <= 3; i++) {
index = i;
for (j = i + 1; j <= 4; j++) {
...
10. [FADE - UFPE - 2023 - UFPE - Analista de Tecnologia da Informação - Área: Sistemas]
...
11. [FADE - UFPE - 2023 - UFPE - Analista de Tecnologia da Informação - Área: Sistemas]
Considere o seguinte código em Java:
public class Main {
public static void main(String[] args) {
...
12. [UFU-MG - 2023 - Analista de Tecnologia da Informação Área 1 - Desenvolvimento de
...
13. [IFRN - 2009 - Professor - Sistemas de Informação] Analise o seguinte código Java,
abaixo:
1 public class test {
